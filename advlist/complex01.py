...
def main():
    ...
    #display the first item in the list (oth item) - first Ip addresses
    print(list1[4][0])

    #create a list of at least 5 animals with three letter names. program output them to screen.
    animals = ["Fox", "Ant", "Bee", "Cod", "Cat", "Dog", "Yak", "Cow", "Hen", "Koi", "Hog", "Jay", "Kit"]
